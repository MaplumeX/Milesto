...
本文件用于把 `docs/prd/01-v0.1-mvp.md` 的 v0.1 MVP 范围，结合工程/红线规范与 UI 原型参考，拆分成“数量不多但可执行”的交付任务，方便按里程碑推进。
...
- UI 原型参考（截图，仅作交互/布局参考）:
  - `docs/design/project page.png`
  - `docs/design/task component.png`
...
目标：把“可运行且不踩红线”的骨架搭起来，为当前 v0.1 功能提供稳定边界。
...
- P1-B Areas：CRUD；Project/Task 归属；删除 Area 的级联删除规则（注意影响导入/导出与筛选一致性）
