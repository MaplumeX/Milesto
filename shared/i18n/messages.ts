...
export const messagesEn = {
  ...
  settings: {
    ...
    syncBucket: 'Bucket',
    syncPrefix: 'Prefix',
    syncForcePathStyle: 'Force path-style requests',
    syncAccessKeyId: 'Access Key ID',
    syncSecretAccessKey: 'Secret Access Key',
    syncStoredCredentials: 'Stored credentials',
    syncStoredCredentialsYes: 'Stored',
    syncStoredCredentialsNo: 'Not stored',
    syncStoredCredentialsHint: 'Credentials are stored securely and are not shown again in plain text.',
    syncStatus: 'Status',
    syncPendingOutbox: 'Pending batches',
    syncLastSuccess: 'Last successful sync',
    syncLastAttempt: 'Last attempted sync',
    syncModeDisabled: 'Disabled',
    syncModeIdle: 'Idle',
    syncModeSyncing: 'Syncing',
    syncModeError: 'Error',
    syncCredentialsRequired: 'Enter Access Key ID and Secret Access Key first.',
    syncTestConnection: 'Test Connection',
    syncSaveConfiguration: 'Save Configuration',
...
export const messagesZhCN = {
  ...
  settings: {
    ...
    syncBucket: 'Bucket',
    syncPrefix: 'Prefix',
    syncForcePathStyle: '强制使用 path-style 请求',
    syncAccessKeyId: 'Access Key ID',
    syncSecretAccessKey: 'Secret Access Key',
    syncStoredCredentials: '已保存凭据',
    syncStoredCredentialsYes: '已保存',
    syncStoredCredentialsNo: '未保存',
    syncStoredCredentialsHint: '凭据已安全保存，界面不会再次明文显示。',
    syncStatus: '状态',
    syncPendingOutbox: '待上传批次',
    syncLastSuccess: '上次成功同步',
    syncLastAttempt: '上次尝试同步',
    syncModeDisabled: '已停用',
    syncModeIdle: '空闲',
    syncModeSyncing: '同步中',
    syncModeError: '错误',
    syncCredentialsRequired: '请先填写 Access Key ID 和 Secret Access Key。',
    syncTestConnection: '测试连接',
    syncSaveConfiguration: '保存配置',
    syncEnable: '启用同步',
    syncDisable: '停用同步',
    syncNow: '立即同步',
    data: '数据',
