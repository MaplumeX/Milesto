...
export const messagesEn = {
  ...
  commandPalette: {
    inputPlaceholder: 'Type to search, or type a new task…',
    ...
    goToAnytime: 'Go to Anytime',
    goToSomeday: 'Go to Someday',
    goToLogbook: 'Go to Logbook',
  ...
  settings: {
    ...
    userData: 'User data',
    shortcuts: 'Shortcuts',
    commandPaletteShortcut: 'Cmd/Ctrl+K (Command Palette)',
...
export const messagesZhCN = {
  ...
  settings: {
    ...
    userData: '用户数据',
    shortcuts: '快捷键',
    commandPaletteShortcut: 'Cmd/Ctrl+K（命令面板）',
