...
| 40 | 2026-05-03 | Fix chat assistant message duplication | `d55b264` | `master` |
...
| 2 | 2026-04-22 | 标签筛选功能实现 | `42559ac` | `master` |
| 1 | 2026-04-18 | 任务元数据 UI 重设计（方案 A - 紧凑图标化） | `01576a2` | `master` |
<!-- @@@/auto:session-history -->
