...
- A top group for tasks with no `section_id`.
...
Project-level actions that exist today (e.g. rename project, move to area, create/rename/delete section, reopen project) SHALL remain available from the Project page.
